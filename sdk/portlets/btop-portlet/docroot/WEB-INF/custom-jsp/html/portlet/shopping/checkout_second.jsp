...
<aui:form action="<%= checkoutSecondURL %>" method="post" name="fm">
	...
	<aui:button-row>
		...
		<%
		String paymentType = PrefsParamUtil.getString(renderRequest.getPreferences(), request, "paymentType");
		%>
		<aui:button type="submit" value='<%= paymentType.equals("Betop") || shoppingPrefs.usePayPal() ? "continue" : "finished" %>' />
