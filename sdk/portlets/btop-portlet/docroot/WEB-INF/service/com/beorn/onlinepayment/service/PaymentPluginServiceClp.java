 ...
 */
public class PaymentPluginServiceClp implements PaymentPluginService {
	public PaymentPluginServiceClp(InvokableService invokableService) {
	...
	public java.util.List<com.beorn.onlinepayment.model.PaymentPlugin> search(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName3,
					...
					ClpSerializer.translateInput(paymentMethodId),
		...
		return (java.util.List<com.beorn.onlinepayment.model.PaymentPlugin>)ClpSerializer.translateOutput(returnObj);
	}
