 ...
 * specified key and this parameter is smaller (as a number) to the specified
 * value.
 * 
 * @author Sébastien Meunier
 */
public class NumberParameterSmallerCondition implements
		Condition<ParametersConditionSubject> {

	public NumberParameterSmallerCondition(String key, double value) {
		_key = key;
		_value = value;
	}

	public NumberParameterSmallerCondition(JSONObject jsonObject)
	...
	public String explain(ConditionExplainContext conditionExplainContext) {
		return conditionExplainContext.format(
				"number-parameter-x-is-smaller-than-x", _key, _value);
	}
	...
	private String _key;
	@ConditionField(label = "is-smaller-than", hint = "parameterValue")
