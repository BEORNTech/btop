...
/**
 * The base implementation of the payment plugin local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.beorn.onlinepayment.service.impl.PaymentPluginLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PaymentPluginLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PaymentPluginLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.beorn.onlinepayment.service.PaymentPluginLocalServiceUtil} to access the payment plugin local service.
	 */
	...
	public PaymentPlugin addPaymentPlugin(PaymentPlugin paymentPlugin)
		throws SystemException {
		paymentPlugin.setNew(true);

		return paymentPluginPersistence.update(paymentPlugin, false);
	}
	 ...
	 */
	public PaymentPlugin createPaymentPlugin(long paymentPluginId) {
		return paymentPluginPersistence.create(paymentPluginId);
	}
	...
	public PaymentPlugin deletePaymentPlugin(long paymentPluginId)
		...
		return paymentPluginPersistence.remove(paymentPluginId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PaymentPlugin.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return paymentPluginPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return paymentPluginPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public PaymentPlugin fetchPaymentPlugin(long paymentPluginId)
		throws SystemException {
		return paymentPluginPersistence.fetchByPrimaryKey(paymentPluginId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PaymentPlugin getPaymentPlugin(long paymentPluginId)
		throws PortalException, SystemException {
		return paymentPluginPersistence.findByPrimaryKey(paymentPluginId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return paymentPluginPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PaymentPlugin getPaymentPluginByUuidAndGroupId(String uuid,
		long groupId) throws PortalException, SystemException {
		return paymentPluginPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<PaymentPlugin> getPaymentPlugins(int start, int end)
		throws SystemException {
		return paymentPluginPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPaymentPluginsCount() throws SystemException {
		return paymentPluginPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PaymentPlugin updatePaymentPlugin(PaymentPlugin paymentPlugin)
		throws SystemException {
		return updatePaymentPlugin(paymentPlugin, true);
	}
	...
	public PaymentPlugin updatePaymentPlugin(PaymentPlugin paymentPlugin,
		...
		return paymentPluginPersistence.update(paymentPlugin, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.beorn.onlinepayment.model.PaymentPlugin",
			paymentPluginLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = paymentPluginPersistence.getDataSource();
	...
	private PaymentPluginLocalServiceClpInvoker _clpInvoker = new PaymentPluginLocalServiceClpInvoker();
}