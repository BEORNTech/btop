...
/**
 * The base implementation of the rule local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.beorn.onlinepayment.service.impl.RuleLocalServiceImpl}.
 * </p>
 *
...
public abstract class RuleLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.beorn.onlinepayment.service.RuleLocalServiceUtil} to access the rule local service.
	 */
	...
	public Rule addRule(Rule rule) throws SystemException {
		...
		return rulePersistence.update(rule, false);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Rule deleteRule(Rule rule) throws PortalException, SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Rule updateRule(Rule rule, boolean merge) throws SystemException {
		rule.setNew(false);

		return rulePersistence.update(rule, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.beorn.onlinepayment.model.Rule",
			ruleLocalService);
	}
