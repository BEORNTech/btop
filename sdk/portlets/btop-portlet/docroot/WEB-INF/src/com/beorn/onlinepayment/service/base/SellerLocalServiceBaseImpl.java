...
/**
 * The base implementation of the seller local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.beorn.onlinepayment.service.impl.SellerLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SellerLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SellerLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.beorn.onlinepayment.service.SellerLocalServiceUtil} to access the seller local service.
	 */
	...
	public Seller addSeller(Seller seller) throws SystemException {
		seller.setNew(true);

		return sellerPersistence.update(seller, false);
	}
	 ...
	 */
	public Seller createSeller(long sellerId) {
		return sellerPersistence.create(sellerId);
	}
	...
	public Seller deleteSeller(long sellerId)
		...
		return sellerPersistence.remove(sellerId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Seller.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return sellerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return sellerPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return sellerPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Seller fetchSeller(long sellerId) throws SystemException {
		return sellerPersistence.fetchByPrimaryKey(sellerId);
	}
	...
	public Seller getSeller(long sellerId)
		throws PortalException, SystemException {
		return sellerPersistence.findByPrimaryKey(sellerId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return sellerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Seller getSellerByUuidAndGroupId(String uuid, long groupId)
		throws PortalException, SystemException {
		return sellerPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Seller> getSellers(int start, int end)
		throws SystemException {
		return sellerPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSellersCount() throws SystemException {
		return sellerPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Seller updateSeller(Seller seller) throws SystemException {
		return updateSeller(seller, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Seller updateSeller(Seller seller, boolean merge)
		throws SystemException {
		seller.setNew(false);

		return sellerPersistence.update(seller, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.beorn.onlinepayment.model.Seller",
			sellerLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = sellerPersistence.getDataSource();
	...
	private SellerLocalServiceClpInvoker _clpInvoker = new SellerLocalServiceClpInvoker();
}